        ...
        if self.alive and player.alive:
            ...
            if self.vision.colliderect(player.rect):
                ...
                if not self.idling:
                    ...
                    self.vision.center = (self.rect.centerx + 75 * self.direction, self.rect.centery)  # 75 is half of vision so enemy sees full rectangle ahead
...
player = Soldier(char_type='player', x=200, y=200, scale=1.5, speed=5, ammo=20, grenades=5)
health_bar = HealthBar(x=10, y=10, health=player.health, max_health=player.max_health)

enemy = Soldier(char_type='enemy', x=500, y=200, scale=1.5, speed=2, ammo=20, grenades=0)
enemy2 = Soldier(char_type='enemy', x=300, y=200, scale=1.5, speed=2, ammo=20, grenades=0)
